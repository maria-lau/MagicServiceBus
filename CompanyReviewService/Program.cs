...
namespace CompanyReviewService
{
    class Program
    {
        /// <summary>
        /// Start point for the Company Review Service
        /// </summary>
        ...
        {
            Console.Title = "CompanyReview";

            //Create a new Endpoint configuration with the name "Company Directory"
            EndpointConfiguration endpointConfiguration = new EndpointConfiguration("CompanyReview");
